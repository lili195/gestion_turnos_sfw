  ...
  return started ? (
    <div>
      ...
      <NavMenu
        ...
        userName={userName}
      />
      {currentPage === PAGES.HOME && (<Home handleService={handleService} handlePage={handleCurrentPage} />)}
      {currentPage === PAGES.SHEDULE && (<SheduleTurn serviceInfo={serviceInfo} userName={userName} />)}
